...
#    Then I should be redirected to the login page
  ...
  Scenario: unauthenticated user can access search
    Given I am not an authenticated user
    When I change the url to "search"
    Then I should be redirected to the login page

  Scenario: unauthenticated user can access favorites
    Given I am not an authenticated user
    When I change the url to "favorites"
    Then I should be redirected to the login page

  Scenario: unauthenticated user can access compare and suggest
    Given I am not an authenticated user
    When I change the url to "compare"
    Then I should be redirected to the login page

    Scenario: authenticated user is logged out after 60 seconds of inactivity
